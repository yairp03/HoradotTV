...
public static class SdarotHelper
{
    ...
    public static async Task DownloadEpisode(EpisodeMediaDetails episode, string downloadLocation, IProgress<(float, float)>? progress = null, CancellationToken ct = default)
    {
